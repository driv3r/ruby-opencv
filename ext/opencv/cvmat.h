...
VALUE rb_accumulate(int argc, VALUE *argv, VALUE self);
VALUE rb_accumulate_square(int argc, VALUE *argv, VALUE self);
VALUE rb_accumulate_product(int argc, VALUE *argv, VALUE self);
VALUE rb_accumulate_weighted(int argc, VALUE *argv, VALUE self);
/* Optical Flow */
