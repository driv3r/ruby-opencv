= OpenCV {<img src="https://secure.travis-ci.org/driv3r/ruby-opencv.png?branch=master" />}[http://travis-ci.org/driv3r/ruby-opencv]

* https://github.com/driv3r/ruby-opencv
